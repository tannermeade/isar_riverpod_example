...
const ProfileSchema = CollectionSchema(
  ...
  properties: {
    r'favoriteColorHex': PropertySchema(
      id: 0,
      name: r'favoriteColorHex',
...
int _profileEstimateSize(
  ...
  bytesCount += 3 + object.favoriteColorHex.length * 3;
...
void _profileSerialize(
  ...
  writer.writeString(offsets[0], object.favoriteColorHex);
...
Profile _profileDeserialize(
  ...
  object.favoriteColorHex = reader.readString(offsets[0]);
  return object;
}
...
extension ProfileQueryFilter
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteColorHexEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'favoriteColorHex',
        value: value,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteColorHexBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition>
      favoriteColorHexContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterFilterCondition> favoriteColorHexMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProfileQuerySortBy on QueryBuilder<Profile, Profile, QSortBy> {
  QueryBuilder<Profile, Profile, QAfterSortBy> sortByFavoriteColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteColorHex', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> sortByFavoriteColorHexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteColorHex', Sort.desc);
    });
  }
...
extension ProfileQuerySortThenBy
  ...
  QueryBuilder<Profile, Profile, QAfterSortBy> thenByFavoriteColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteColorHex', Sort.asc);
    });
  }

  QueryBuilder<Profile, Profile, QAfterSortBy> thenByFavoriteColorHexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'favoriteColorHex', Sort.desc);
    });
  }
...
extension ProfileQueryWhereDistinct
  ...
  QueryBuilder<Profile, Profile, QDistinct> distinctByFavoriteColorHex(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'favoriteColorHex',
          caseSensitive: caseSensitive);
    });
  }
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, String, QQueryOperations> favoriteColorHexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'favoriteColorHex');
    });
  }
